...
class ChatDataset(data.Dataset):
    ...
    def __init__(self, intents_file_path):
        ...
        for (pattern_sentence, tag) in xy:
            ...
            sentence_indices = [self.word_to_idx[self.stemmer.stem(w.lower())] for w in pattern_sentence if self.stemmer.stem(w.lower()) in self.word_to_idx]
